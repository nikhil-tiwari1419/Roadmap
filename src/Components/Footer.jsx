...
function Footer() {
  return (
    <footer className='border-t mt-10 py-10 '>
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto border p-2 border-dashed'>
        {/* About */}
        <div>
          <h3 className='text-lg font-semibold mb-3 text-blue-400'>About Me</h3>
        ...
        <div>
          <h3 className='text-lg font-semibold mb-3 text-blue-400'>Contact</h3>
          <ul className='space-y-2 text-sm text-gray-400'>
